...
import app.fb.entities.Album;
import app.fb.entities.Feed;
import app.fb.entities.Photo;
import app.fb.entities.Profile;
import app.fb.entities.Story;
import app.fb.utils.Errors;
import app.fb.utils.Logger;
import app.fb.utils.Errors.ErrorMsg;
...
public class FacebookController
{
	...
	public void getProfile(final OnProfileRequestListener onProfileRequestListener)
	{
		...
		bundle.putString("fields", "picture.type(large),quotes,email,first_name,last_name,username,gender,birthday,name,bio,location");
		if (isLogin())
		{
